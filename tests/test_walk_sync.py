...
def _make_mcp_importable():
    """Set up env and psycopg2 mocks so mcp_server can be imported without hitting the DB."""
    env_patch = patch.dict(os.environ, {
        "NEON_DB_URL": "postgresql://fake:fake@localhost/fake",
        "MECRIS_MODE": "standalone",
    })
    db_patch = patch("psycopg2.connect")
