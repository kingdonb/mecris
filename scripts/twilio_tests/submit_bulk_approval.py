...
try:
    with open("data/pending_templates.json", "r") as f:
        pending_templates = json.load(f)
except FileNotFoundError:
    print("Error: pending_templates.json not found. Run create_bulk_utility_templates.py first.")
    exit(1)
...
print("\nSubmission process complete. Check Twilio Content Editor for status.")
